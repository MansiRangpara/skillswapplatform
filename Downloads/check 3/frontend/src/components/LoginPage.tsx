...
const LoginPage: React.FC<LoginPageProps> = ({ onLogin, onSignup, onHome , goToForgotPassword}) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (selectedRole.toLowerCase() === 'instructor') {
      try {
        const res = await axios.post('http://localhost:5000/api/instructors/login-instructor', {
          email,
          password,
        });
      ...
      alert('Only Instructor login is connected to backend');
    }
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-4">
              <button className="text-gray-700 hover:text-purple-600 transition-colors">Login</button>
              <button
                onClick={onSignup}
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="mt-2 text-gray-600">
                  Explore, learn, and grow with us. Enjoy a seamless and enriching educational journey.
                </p>
              </div>
