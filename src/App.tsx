...
function App() {
  ...
  if (!isAuthenticated) {
    if (currentPage === 'login') {
      return (
        <LoginPage onLogin={handleLogin} onSignup={() => setCurrentPage('signup')} onHome={() => setCurrentPage('landing')} />
      );
    }
    if (currentPage === 'signup') {
      return (
        <SignupPage onSignup={handleLogin} onLogin={() => setCurrentPage('login')} onHome={() => setCurrentPage('landing')} />
      );
    }
    return (
